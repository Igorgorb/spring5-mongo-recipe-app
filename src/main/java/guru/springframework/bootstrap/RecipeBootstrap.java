...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
  ...
  public void onApplicationEvent(ContextRefreshedEvent event) {
    ...
    log.error("######################################");
    log.error("Count Before bootstrap load data: " + reactiveRepository.count().block().toString());
    ...
    log.error("######################################");
    log.error("Count After bootstrap load data: " + reactiveRepository.count().block().toString());
